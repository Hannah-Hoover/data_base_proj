...
String[] TUPLES = {"insert into User(email, firstName, lastName, password, birthday, adress_street_num, adress_street, adress_city, adress_state, adress_zip_code, cash_bal, PPS_bal)"+
            ...
            "VALUES " +
	                      "('000', '000.00', 'default', 'pending'),"+
	                      "('111', '1000.00', '1 week', 'pending'),"+
	                      "('222', '1200.00', '3 days', 'accepted'),"+
	                      "('333', '800.00', '2 weeks', 'canceled'),"+
	                      "('444', '300.00', '1 week', 'canceled'),"+
	                      "('555', '900.00', '3 weeks', 'accepted'),"+
	                      "('666', '400.00', '1 month', 'accepted'),"+
	                      "('777', '850.00', '5 days', 'pending'),"+
	                      "('888', '700.00', '4 days', 'pending'),"+
	                      "('999', '300.00', '2 weeks', 'pending'),"+
	                      "('112', '1100.00', '1 week', 'pending');"
	    			};
